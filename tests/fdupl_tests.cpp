...
TEST(Fdupl_test, Test_should_be_positive)
{
    EXPECT_TRUE(true);
}
...
TEST(Fdupl_process_dir, Test_should_find_six_sets_of_files)
{
    ...
    EXPECT_EQ(result.size(), 6);  // should be six set of same files including same files in different folders
}
